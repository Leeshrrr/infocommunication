...
class StudyMaterial_Card {
    ...
    constructor({id, title, year, video_source, video_link, emotion}) {
        this._id = id + "";
        this._title = title + "";
        this._year = year + "";
    ...
    _createCard () {
        ...
        let cardImg_Html = `<div class="card-img-top" target="_blank">
                            ...
                            <img class="preview" src="./assets/study_material_preview_img/${this._id}.png">
                            </div>`;
        ...
        // let cardText_Html = `<p class="card-text"><a href="${this._link}" target="_blank">${this._source} · ${this._year}</a><span class="hidden-id">No. ${this._id}</span></p>`;
        // let cardText_Html = `<p class="card-text"><span class="hidden-id">No. ${this._id}</span></p>`;

        deck_single_node.classList.add("col", "video-deck-single", this._emotion);
        card.classList.add("card");
        card_body.classList.add("story-card-body");

        // card_body.innerHTML = cardTitle_Html + cardText_Html;
        // card_body.innerHTML = cardTitle_Html + cardNum_Html;
